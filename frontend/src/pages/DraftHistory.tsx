    ...
    return (
        <Layout variant="container">
            <div className="flex justify-between items-center mb-4">
                <h1 className="text-3xl font-bold text-white">Draft History</h1>
                <button
                    onClick={refetch}
                    disabled={historyLoading}
                    className="px-4 py-2 bg-accent-primary text-text-on-accent rounded-md hover:bg-accent-primary-hover disabled:bg-gray-500"
                >
