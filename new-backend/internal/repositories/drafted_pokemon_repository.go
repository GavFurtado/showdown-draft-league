...
type DraftedPokemonRepository struct {
	db *gorm.DB
}

func NewDraftedPokemonRepository(db *gorm.DB) *DraftedPokemonRepository {
	return &DraftedPokemonRepository{db: db}
}

// creates a new drafted Pokemon entry
func (r *DraftedPokemonRepository) CreateDraftedPokemon(draftedPokemon *models.DraftedPokemon) (*models.DraftedPokemon, error) {
...
func (r *DraftedPokemonRepository) GetDraftedPokemonByID(id uuid.UUID) (*models.DraftedPokemon, error) {
...
func (r *DraftedPokemonRepository) GetDraftedPokemonByPlayer(playerID uuid.UUID) ([]models.DraftedPokemon, error) {
	var draftedPokemon []models.DraftedPokemon
...
func (r *DraftedPokemonRepository) GetDraftedPokemonByLeague(leagueID uuid.UUID) ([]models.DraftedPokemon, error) {
	var draftedPokemon []models.DraftedPokemon
...
func (r *DraftedPokemonRepository) GetActiveDraftedPokemonByLeague(leagueID uuid.UUID) ([]models.DraftedPokemon, error) {
	var draftedPokemon []models.DraftedPokemon
	err := r.db.Preload("Player").
		Preload("Player.User").
		Preload("PokemonSpecies").
...
func (r *DraftedPokemonRepository) GetReleasedPokemonByLeague(leagueID uuid.UUID) ([]models.DraftedPokemon, error) {
	var draftedPokemon []models.DraftedPokemon
	err := r.db.Preload("Player").
		Preload("Player.User").
		Preload("PokemonSpecies").
...
func (r *DraftedPokemonRepository) IsPokemonDrafted(leagueID, pokemonSpeciesID uuid.UUID) (bool, error) {
	var count int64
...
func (r *DraftedPokemonRepository) GetNextDraftPickNumber(leagueID uuid.UUID) (int, error) {
...
func (r *DraftedPokemonRepository) ReleasePokemon(draftedPokemonID uuid.UUID) error {
	err := r.db.Model(&models.DraftedPokemon{}).
...
func (r *DraftedPokemonRepository) ReDraftPokemon(draftedPokemonID, newPlayerID uuid.UUID, newPickNumber int) error {
...
func (r *DraftedPokemonRepository) GetDraftedPokemonCountByPlayer(playerID uuid.UUID) (int64, error) {
	var count int64
	err := r.db.Model(&models.DraftedPokemon{}).
		Where("player_id = ? AND is_released = ?", playerID, false).
		Count(&count).Error
...
func (r *DraftedPokemonRepository) GetDraftHistory(leagueID uuid.UUID) ([]models.DraftedPokemon, error) {
	var draftedPokemon []models.DraftedPokemon
	err := r.db.Preload("Player").
		Preload("Player.User").
		Preload("PokemonSpecies").
...
func (r *DraftedPokemonRepository) TradePokemon(draftedPokemonID, newPlayerID uuid.UUID) error {
	err := r.db.Model(&models.DraftedPokemon{}).
		Where("id = ?", draftedPokemonID).
...
func (r *DraftedPokemonRepository) DeleteDraftedPokemon(draftedPokemonID uuid.UUID) error {
