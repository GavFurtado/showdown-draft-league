...
func NewLeagueMemberRepository(db *gorm.DB) PlayerRepository {
	return &playerRepositoryImpl{
		db: db,
	}
}

// CreateLeagueMember a new LeagueMember in a league
func (r *leagueMemberRepositoryImpl) CreateLeagueMember(member *models.LeagueMember) (*models.LeagueMember, error) {
...
// GetLeagueMemberbyID gets player by ID with preloaded relationships
func (r *leagueMemberRepositoryImpl) GetLeagueMemberbyID(id uuid.UUID) (*models.LeagueMember, error) {
...
// GetLeagueMemberByUserAndLeague gets LeagueMember by user ID and league ID
func (r *leagueMemberRepositoryImpl) GetLeagueMemberByUserAndLeague(userID, leagueID uuid.UUID) (*models.LeagueMember, error) {
	var member models.LeagueMember
	err := r.db.
...
// GetPlayersByLeague gets all players in a specific league
func (r *leagueMemberRepositoryImpl) GetPlayersByLeague(leagueID uuid.UUID) ([]models.Player, error) {
...
func (r *leagueMemberRepositoryImpl) GetPlayersByLeagueAndGroupNumber(leagueID uuid.UUID, groupNumber int) ([]models.Player, error) {
	var players []models.Player
	err := r.db.
...
// gets all players for a specific user across all leagues
func (r *leagueMemberRepositoryImpl) GetPlayersByUser(userID uuid.UUID) ([]models.Player, error) {
	var players []models.Player
	err := r.db.
...
// UpdateLeagueMember updates player information
func (r *leagueMemberRepositoryImpl) UpdateLeagueMember(member *models.LeagueMember) (*models.LeagueMember, error) {
	// TODO: refactor - needs to be specific
	...
	return r.GetLeagueMemberbyID(member.ID)
}

// UpdateLeagueMemberDraftPoints updates player's draft points
func (r *leagueMemberRepositoryImpl) UpdateLeagueMemberDraftPoints(playerID uuid.UUID, newPoints int) error {
...
// updates player's win/loss record
func (r *leagueMemberRepositoryImpl) UpdatePlayerRecord(playerID uuid.UUID, wins, losses int) error {
...
func (r *leagueMemberRepositoryImpl) UpdatePlayerDraftPosition(playerID uuid.UUID, newPosition int) error {
	err := r.db.Model(&models.Player{}).
		Where("id = ?", playerID).
...
func (r *leagueMemberRepositoryImpl) UpdatePlayerRole(playerID uuid.UUID, playerRole rbac.PlayerRole) error {
	err := r.db.Model(&models.Player{}).
		Where("id = ?", playerID).
...
func (r *leagueMemberRepositoryImpl) GetPlayerCountByLeague(leagueID uuid.UUID) (int64, error) {
	var count int64
	err := r.db.Model(&models.Player{}).
		Where("league_id = ?", leagueID).
		Count(&count).Error
...
// soft deletes a player from a league
func (r *leagueMemberRepositoryImpl) DeletePlayer(playerID uuid.UUID) error {
	tx := r.db.Begin()
	if tx.Error != nil {
...
func (r *leagueMemberRepositoryImpl) GetPlayerWithFullRoster(playerID uuid.UUID) (*models.Player, error) {
...
func (r *leagueMemberRepositoryImpl) FindPlayerByUserAndLeague(userID, leagueID uuid.UUID) (*models.Player, error) {
	var player models.Player
	err := r.db.
		Where("user_id = ? AND league_id = ?", userID, leagueID).
		First(&player).Error
...
// Returns (player, nil) if found, (nil, nil) if not found, (nil, error) for other DB errors.
func (r *leagueMemberRepositoryImpl) FindPlayerByInLeagueNameAndLeagueID(inLeagueName string, leagueID uuid.UUID) (*models.Player, error) {
	var player models.Player
	err := r.db.
...
// Returns (player, nil) if found, (nil, nil) if not found, (nil, error) for other DB errors.
func (r *leagueMemberRepositoryImpl) FindPlayerByTeamNameAndLeagueID(teamName string, leagueID uuid.UUID) (*models.Player, error) {
	var player models.Player
	err := r.db.
