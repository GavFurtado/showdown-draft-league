...
type Player struct {
	...
	DraftPosition  int            `json:"draft_position"` // turn order a player pick (possibly/probably randomized)
	IsCommissioner bool           `gorm:"not null;deafult:false" json:"is_commissioner"`
