...
type Game struct {
	...
	// Relationships
	ReportingPlayer Player `gorm:"foreignKey:reporting_player_id;references:ID" json:"ReportingPlayer"`
	League          League `gorm:"foreignKey:league_id;references:id" json:"League"`
	Player1         Player `gorm:"foreignKey:player1_id;references:ID" json:"Player1"`
	Player2         Player `gorm:"foreignKey:player2_id;references:ID" json:"Player2"`
	Winner          Player `gorm:"foreignKey:winner_id;references:ID" json:"Winner"`
	Loser           Player `gorm:"foreignKey:loser_id;references:ID" json:"Loser"`
}
