...
type League struct {
	...
	Visibility             enums.LeagueVisibility `gorm:"type:varchar(10);not null;default:'private';column:visibility" json:"Visibility"`
	...
	Members   []LeagueMember `gorm:"foreignKey:league_id" json:"Members,omitempty"`
	// League has many PoolEntries (its defined draft pool)
	PoolEntries []PoolEntry `gorm:"foreignKey:league_id" json:"-"`
	// League has many Claims (all Pokemon drafted/transferred in this league)
	Claims []Claim `gorm:"foreignKey:league_id" json:"-"`
}
